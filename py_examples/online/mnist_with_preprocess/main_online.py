# This is an example code to create a main_online.py for online API

import warnings
warnings.filterwarnings("ignore")

from mnist_predict import mnist_preprocess
from mnist_predict import mnist_predict

def preprocess():
    preprocess_assets = mnist_preprocess()
    return preprocess_assets

def main_process(payload, preprocess_assets):
    output_json_str = mnist_predict(payload, preprocess_assets)
    return output_json_str

if __name__ == '__main__':
    preprocess_assets = preprocess()

    input_json = {"input_data": [{"fields": ["image"], "values": [[[[-0.4242129623889923, -0.4242129623889923,
                                                                     ...
                                                                     -0.4242129623889923, -0.4242129623889923,
                                                                     -0.4242129623889923, -0.4242129623889923]]]]}]}
    output_json_str = main_process(input_json, preprocess_assets)
    print('output_json=\n', output_json_str)
